            ...
            <div className="w-10/10 p-3 pl-0">
                <div className="flex justify-between">
                    <div>
                        ...
                        <span className="text-grey-dark">9 Apr, 2019</span>
                    </div>
                ...
                <div>
                    ...
                    <div className="pb-2">
                        <span className="mr-8">
                            <a href="#" className="text-grey-dark no-underline hover:no-underline hover:text-blue-light">
                                <i className="fa fa-comment fa-lg mr-2"></i> 19
                            </a>
                        </span>
                        <span className="mr-8">
                            <a href="#" className="text-grey-dark no-underline hover:no-underline hover:text-green">
                                <i className="fa fa-heart fa-lg mr-2"></i> 56
                            </a>
                        </span>
                        <span className="mr-8">
                            <a href="#" className="text-grey-dark no-underline hover:no-underline hover:text-red">
